...
import { X as XIcon, ArrowLeft as ArrowLeftIcon, ArrowRight as ArrowRightIcon, Search as SearchIcon, TriangleAlert as AlertTriangleIcon } from "lucide-vue-next";
